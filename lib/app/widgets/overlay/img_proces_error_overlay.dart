                    ...
                    child: RichText(
                      ...
                      text: const TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text:
                                ', please use laptop or computer browser instead of mobile browser',
                            style: TextStyle(
                              color: Colors.black,
                            ),
                          ),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      padding: EdgeInsets.symmetric(
                        vertical: 15.0,
                        horizontal:
                            MediaQuery.of(context).size.width < 350 ? 15 : 35.0,
                      ),
                    ),
                    onPressed: () => OverlaySer().removeOverlay('errorOverlay'),
                    child: const Text(
                      'Noticed',
                      style: TextStyle(
                        color: Colors.black,
